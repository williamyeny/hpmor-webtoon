...
.book{position:relative;display:block;width:12.5rem;height:16rem;margin:1.6rem auto 3.6rem;text-decoration:none;perspective:900px;-webkit-tap-highlight-color:transparent}
...
.book .face{position:absolute;inset:22px 20px 52px 32px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;color:#e7c46a;
...
.book .lbl{position:absolute;left:26px;right:14px;bottom:24px;display:flex;align-items:center;justify-content:center;gap:.4rem;white-space:nowrap;font-family:'IM Fell English SC',serif;font-size:.9rem;letter-spacing:.5px;color:#f0d27e;text-shadow:0 1px 0 rgba(0,0,0,.5)}
.book .lbl:before,.book .lbl:after{content:'';flex:0 1 .8rem;height:1px;background:#c9a24a;opacity:.8}
...
<span class="pages"></span><span class="ribbon"></span><span class="cover"><span class="spine"></span><span class="face"><span class="ep">Episode 1</span><span class="orn"></span><span class="ttl">${esc(ready[0].title)}</span></span><span class="lbl">Begin reading</span></span>
