...
export const POSES = {
  ...
  armsUp:     { armF: { sh: -155, el: -15, hand: 'splay' }, armB: { sh: 155, el: 15, hand: 'splay' }, legF: { hip: -8 }, legB: { hip: 8 } },
  panic:      { armF: { sh: -120, el: -50, hand: 'splay' }, armB: { sh: 125, el: 45, hand: 'splay' }, legF: { hip: -10, knee: 8 }, legB: { hip: 12, knee: -6 }, lean: -4 },
  point:      { armF: { sh: 82, el: 4, hand: 'point' }, armB: { sh: 10, el: -8 }, legF: { hip: -4 }, legB: { hip: 6 }, lean: 3 },
  pointUp:    { armF: { sh: 150, el: 10, hand: 'point' }, armB: { sh: 8, el: -6 }, legF: { hip: -4 }, legB: { hip: 6 } },
  raiseHand:  { armF: { sh: 165, el: 5, hand: 'open' }, armB: { sh: 8, el: -6 }, legF: { hip: -3 }, legB: { hip: 4 } },
  holdUp:     { armB: { sh: 168, el: 4, hand: 'hold' }, armF: { sh: -8, el: 20, hand: 'fist' }, legF: { hip: -6 }, legB: { hip: 6 }, lean: -3 },
  present:    { armF: { sh: 60, el: 35, hand: 'palm' }, armB: { sh: 20, el: 30 }, legF: { hip: -3 }, legB: { hip: 5 } },
  ...
  wave:       { armF: { sh: 150, el: 30, hand: 'palm' }, armB: { sh: 8, el: -6 }, legF: { hip: -3 }, legB: { hip: 4 } },
  ...
  gesture:    { armF: { sh: 40, el: 60, hand: 'palm', hr: -20 }, armB: { sh: 10, el: -8 }, legF: { hip: -3 }, legB: { hip: 5 } },
  gesture2:   { armF: { sh: 55, el: 30, hand: 'open' }, armB: { sh: 30, el: 60, hand: 'palm' }, legF: { hip: -4 }, legB: { hip: 5 } },
  lecture:    { armF: { sh: 110, el: 40, hand: 'point' }, armB: { sh: 15, el: 60, hand: 'hold' }, legF: { hip: -4 }, legB: { hip: 6 }, lean: -2 },
  wand:       { armF: { sh: 95, el: -10, hand: 'hold' }, armB: { sh: 10, el: -6 }, legF: { hip: -6 }, legB: { hip: 8 } },
  wandUp:     { armF: { sh: 140, el: -20, hand: 'hold' }, armB: { sh: -10, el: -10 }, legF: { hip: -8 }, legB: { hip: 8 }, lean: -4 },
...
export function drawCharacter(def, opts = {}) {
  ...
  // ---- head
  const H = drawHead(def, { turn: ht, expr, lw, light, tilt: lean * 0.6 + headTilt, extras: opts.extras || {}, hatOff: opts.hatOff, hairOverride: opts.hair });
...
export function drawHead(def, o) {
  ...
  if (F.lips && !['shout', 'scream', 'grin', 'laugh', 'smile', 'o', 'open'].includes(mSt.type)) out.push(ellipse(mz.x + s * 3, F.mouthY + 5, (F.mouth?.w ?? 20) * 0.28, 2.6, { fill: F.lips, opacity: 0.55 }));
  // extras
