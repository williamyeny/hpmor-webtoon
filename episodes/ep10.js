...
ep.panel(900, { cam: { on: ['hermione'], fr: 'bust', zoom: 0.85, dy: -0.1 }, bg: CP(), blur: 2, actors: [HER({ pose: 'sitRead', expr: { base: 'think', eyes: { lookX: 0.4 } }, armF: BOOK, armB: BOOKB })] },
...
ep.panel(1000, { cam: { on: ['hermione'], fr: 'waist', zoom: 0.75, dy: -0.3 }, bg: CP(), actors: [HER({ pose: 'sitRead', expr: 'smile', armF: BOOK, armB: BOOKB })] },
...
ep.bleed(760, { cam: { on: ['harry'], fr: 'close', dy: 0.1 }, bg: CP(), blur: 3, actors: [HAR({ expr: 'grin' })], over: (e) => {
...
ep.panel(660, { cam: { on: ['harry'], fr: 'bust', zoom: 0.85, dy: -0.2 }, bg: CP(), blur: 2, actors: [HAR({ expr: 'scheme', pose: 'present', armB: { sh: 80, el: 35, hand: 'palm' } })], over: (e) => atHand(e, 'harry', 'handB', comedCan(1.2), -16, -20) },
...
ep.bleed(1000, { cam: { on: ['hermione'], fr: 'waist' }, bg: CP(), blur: 3, actors: [HER({ expr: 'horror', pose: 'panic', seat: undefined, y: 900, x: 560 })], behind: (e) => FX.burst(e.w, e.h, e.w / 2, e.h * 0.4, { bg: '#e8ffd8', col: '#6ad05a', op: 0.6 }), over: (e) => spray(e.w * 0.5, e.h * 0.74, 1, 2) + spray(e.w * 0.5, e.h * 0.74, -1, 1.6) },
...
ep.bleed(870, { cam: { on: ['hermione'], fr: 'bust', dy: -0.1, dx: 0.3 }, bg: CP(), blur: 3, actors: [HER({ expr: 'delight', pose: 'point' })], behind: (e) => FX.burst(e.w, e.h, e.w / 2, e.h * 0.4, { col: '#f0c878', op: 0.5 }) },
...
ep.multi(920, [
  ...
  { x: 392, y: 18, w: 384, h: 884, mood: 'day', art: { cam: { head: 'hermione', hw: 0.72, hx: 0.5, hy: 0.4 }, bg: CP(), blur: 3, actors: [HER({ expr: 'determined' })] } },
], [say('Harry', 'I can do calculus, and I know Bayesian probability theory, and decision theory, and I\'ve read *The Feynman Lectures*…', 200, 262, { w: 250, size: 24, pad: 20, fixed: true, tail: 'harry' }), say('Hermione', '…and I can name the twelve uses of dragon\'s blood…', 584, 705, { w: 262, size: 24, pad: 12, fixed: true, tail: 'hermione' })],
...
ep.panel(760, { cam: { head: 'harry', hw: 0.84, hx: 0.5, hy: 0.37, roll: -5 }, bg: CP(), blur: 3, actors: [HAR({ expr: 'cold' })], over: (e) => FX.frost(e.w, e.h, 0.6, 40) },
  [cold('Harry', 'What were his colours? Green and silver?', 400, 682, { w: 460, fixed: true })], { mood: 'cold', alt: 'Harry\'s face changes. His voice goes cold.' });
