...
ep.panel(760, { cam: { on: ['quirrell'], fr: 'close', dy: -0.35 }, bg: STAFF, blur: 2, actors: [...staff(), () => HG.staffTable()], over: (e) => FX.doom(e.w, e.h, 8) },
  [cap('And further along, the pale man from the Leaky Cauldron. His eyes darted around in panic, and he twitched in his seat. For some reason, Harry kept finding himself staring at him.', 44, 34, { w: 480, size: 25 }),
