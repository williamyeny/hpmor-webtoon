...
ep.bleed(900, { cam: { x: 800, y: 700, w: 1400 }, bg: () => HG.hallTable('s'), actors: [...[1211, 1212, 1213, 1214, 1215, 1216, 1217].map((sd, i) => ({ def: student(sd, ['g', 'r', 'h', 's'][i % 4]), id: 't' + i, x: 150 + i * 220, y: 1050, s: 1.05, turn: i < 3 ? 0.4 : -0.4, expr: { base: 'awe', eyes: { sparkle: false, lookX: i < 3 ? 1 : -1 } } })), () => HG.tableFront()] },
...
ep.panel(760, { cam: { x: 1100, y: 700, w: 1100 }, bg: () => HG.hallTable('g'), actors: [{ def: fred, id: 'fred', x: 950, y: 1050, turn: 0.3, pose: 'point', expr: 'bigGrin' }, { def: george, id: 'george', x: 1200, y: 1050, turn: -0.3, pose: 'raiseHand', expr: 'laugh' }, () => HG.tableFront()] },
