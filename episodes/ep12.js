...
ep.bleed(820, mind('void', null, { harry: HM('horror', 'panic', { x: 0, y: 70 }), zoom: 0.45 }), [shout('Harry', '*WHAT?*', 400, 100, { w: 220, size: 54, noTail: true })], { alt: 'Harry, in his own head, panics.' });
...
ep.panel(900, (ctx) => mind('cold', null, { frost: 0.7 })(ctx) + shot({ cam: { on: ['harry'], fr: 'bust', dy: -0.25 }, actors: [{ def: harryRobes, id: 'harry', x: 0, y: 0, s: 1.1, turn: 0.1, expr: 'cold', extras: { glint: false } }] })(ctx),
  [hat('*You don\'t like yourself when you\'re angry. It is like wielding a sword whose hilt is sharp enough to draw blood from your own hand. Like looking at the world through a monocle of ice that freezes your eye even as it sharpens your vision.*', 400, 150, { w: 490, size: 27 })], { border: 'none', mood: 'cold', alt: 'Harry in cold blue light, frost over everything.' });
...
ep.panel(820, mind('void', 'sleep', { hs: 1.6, hy: 0.72 }), [cap('The Hat sighed a terrible, sad sigh.', 44, 30, { w: 560 }), hat('*And so before too long you will become another memory, to be felt and never known, in the next warning that I give…*', 400, 700, { w: 540 })], { border: 'none' });
...
], [cap('Hagrid gasped in horror.', 40, 30, { w: 300 }), cap('McGonagall staggered.', 420, 30, { w: 280 }), cap('Students screamed. People fell off their benches.', 40, 470, { w: 620 })],
...
ep.panel(470, todo(['1. Research mind magic. All of it.', '2. Read the titles of every book in the library.', '3. Find out what "speak to my snake" means…'], []),
  [cap('Harry started a list, the way he always did.', 176, 380, { w: 560, fixed: true })], { alt: 'Harry\'s to-do list: research mind magic; read every book title in the library; find out what "speak to my snake" means…' });
